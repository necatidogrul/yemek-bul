...
export class SpeechService {
  ...
  static extractIngredientsFromText(text: string): string[] {
    ...
    const ingredientDictionary = [
      // Sebzeler
      "domates", "salçalık", "köy domatesi", "cherry domates",
      "soğan", "kuru soğan", "taze soğan", "yeşil soğan",
      "sarımsak", "taze sarımsak",
      "biber", "yeşil biber", "kırmızı biber", "sivri biber", "dolma biber", "çarliston biber",
      "patates", "taze patates", "haşlama patates",
      "havuç", "taze havuç",
      "kabak", "sakız kabağı", "beyaz kabak",
      "pırasa", "taze pırasa",
      "ıspanak", "taze ıspanak", "dondurulmuş ıspanak",
      "lahana", "beyaz lahana", "kırmızı lahana",
      "brokoli", "karnabahar",
      "kereviz", "kereviz sapı",
      "marul", "roka", "maydanoz", "dereotu", "nane", "fesleğen", "kekik",
      
      // Etler
      "kıyma", "dana kıyma", "kuzu kıyma", "karışık kıyma",
      "tavuk", "tavuk eti", "tavuk göğsü", "tavuk but",
      "et", "dana eti", "kuzu eti", "sığır eti",
      "balık", "ton balığı", "somon", "levrek", "çipura",
      
      // Tahıllar ve Karbonhidratlar
      "pirinç", "baldo pirinç", "osmancık pirinç",
      "bulgur", "köftelik bulgur", "pilavlık bulgur",
      "makarna", "spagetti", "penne", "fırın makarnası",
      "nohut", "kuru nohut", "haşlanmış nohut",
      "mercimek", "kırmızı mercimek", "yeşil mercimek",
      ...
      "peynir", "beyaz peynir", "kaşar peyniri", "tulum peyniri", "feta peynir",
      "tereyağı", "margarin",
      "krema", "krema şanti",
      ...
      "sos", "soya sosu", "barbekü sos",
      "sirke", "elma sirkesi", "üzüm sirkesi",
      
      // Baharatlar
      "tuz", "deniz tuzu", "sofra tuzu",
      "karabiber", "taze çekilmiş karabiber",
      "kırmızı biber", "pul biber", "acı biber",
      "kimyon", "kişniş", "köri",
      "tarçın", "karanfil", "defne yaprağı",
      
      // Meyveler
      "limon", "taze limon", "limon suyu",
      "portakal", "portakal suyu",
      "elma", "yeşil elma", "kırmızı elma",
      "muz", "olgun muz",
      "çilek", "taze çilek",
      "üzüm", "kuru üzüm", "sultani üzüm",
      "armut", "ankara armut",
      
      // Diğerleri
      "ekmek", "taze ekmek", "bayat ekmek",
      "lavaş", "yufka", "tortilla",
      "pide", "ramazan pidesi",
      "çikolata", "bitter çikolata", "sütlü çikolata",
      "bal", "çiçek balı", "kestane balı",
      "reçel", "çilek reçeli", "kayısı reçeli",
      "turşu", "karışık turşu",
      "zeytin", "yeşil zeytin", "siyah zeytin"
    ];
  ...
  static async speechToText(options?: {
    ...
    return new Promise((resolve, reject) => {
      ...
      reject(new Error('Sesli giriş özelliği şu anda desteklenmiyor. Lütfen malzemelerinizi manuel olarak girin.'));
    });
  }
