...
if (!env) {
  ...
  console.log('  npm run env:dev     - Development ortamı (100 kredi, admin panel)');
  console.log('  npm run env:test    - Test ortamı (production benzeri, 1 kredi)');
...
switch (env) {
  ...
  case 'production':
    ...
    console.log('  - Gerçek RevenueCat entegrasyonu');
    break;
}
